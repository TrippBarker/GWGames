...
public class FizzBuzz {
	...
	public void playGame() {
		...
		System.out.println("    2. If the number is divisible by 3 the player will say \"Fizz\"");
		...
		while (playing) {
			computerAnswer = determineFizzBuzz(computerNumber);
			computerNumber += 2;
			System.out.printf("Computer Says: %s\n", computerAnswer);
			System.out.print("Your Turn....: ");
			userAnswer = input.nextLine();
			correctUserAnswer = determineFizzBuzz(userNumber);
